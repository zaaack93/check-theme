...
var ProductCard = /*#__PURE__*/function (_HTMLElement) {
  ...
  function ProductCard() {
    ...
    _this.addEventListener('click', _this.expandCard);
    return _this;
  }
  _createClass(ProductCard, [{
    key: "expandCard",
    value: function expandCard(event) {
      var _this2 = this;
      event.preventDefault();
      this.classList.add('bs-devshop__product-card__expanded');
      setTimeout(function () {
        window.location.href = _this2.dataset.productUrl;
      }, 1500);
    }
  }]);
  return ProductCard;
...
/******/ 	__webpack_require__.O(undefined, ["assets/css-file"], () => (__webpack_require__("./src/js/custom.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["assets/css-file"], () => (__webpack_require__("./src/scss/css-file.scss")))
